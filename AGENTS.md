# Torii CLI — Agent Build Instructions

## Which file to use for your agent

| Agent | Instruction File | Auto-detected? |
|-------|-----------------|----------------|
| Claude Code | `CLAUDE.md` | Yes (`claude /init`) |
| Cursor | `.cursorrules` | Yes (auto-loaded) |
| GitHub Copilot | `.github/copilot-instructions.md` | Yes (auto-loaded) |
| Codex CLI | `AGENTS.md` | Yes (auto-discovered from repo root) |
| Codex App | `AGENTS.md` | Yes (auto-discovered from repo root) |
| Codex IDE Extension | `AGENTS.md` | Yes (auto-discovered from repo root) |
| Codex Web (Cloud) | `AGENTS.md` | Yes (auto-discovered from repo root) |
| Aider | Point to `AGENTS.md` with `--read AGENTS.md` | Manual |
| Cline | Add `AGENTS.md` to context | Manual |
| Continue | Add `AGENTS.md` to context | Manual |
| Warp AI | Paste or reference `AGENTS.md` | Manual |
| Gemini CLI | Point to `AGENTS.md` | Manual |
| OpenHands | Add `AGENTS.md` to workspace context | Manual |
| Devin | Include `AGENTS.md` in knowledge base | Manual |
| Any other agent | Read `AGENTS.md` as your build instructions | Manual |

All four instruction files contain identical build instructions.
Use whichever one your agent supports natively.
